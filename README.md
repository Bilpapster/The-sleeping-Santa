...
The current repository hosts C++ source code that solves the "Santa Claus problem". This is a concurrent programming problem published by John Trono in 1994. The solution of the problem is approached using ***semaphores***.
